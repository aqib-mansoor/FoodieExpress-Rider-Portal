    ...
    <div className="min-h-screen bg-stone-50 flex flex-col items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-10">
          <div className="w-16 h-16 bg-[#FF6B00] rounded-2xl flex items-center justify-center text-white font-bold text-3xl mx-auto mb-6 shadow-lg shadow-orange-500/20">F</div>
